...
public class VuSession implements Vuforia.UpdateCallbackInterface {

    private static final String LOGTAG = "SampleVuSession";

    // Reference to the current activity
    private Activity mActivity;
    private VuControl mSessionControl;
    ...
    public VuSession(VuControl sessionControl)
    {
    ...
    {
        VuException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new VuException(
                    VuException.VUFORIA_ALREADY_INITIALIZATED,
                    logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new VuException(
                        VuException.INITIALIZATION_FAILURE,
                        logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws VuException
    {
        String error;
        if(mCameraRunning)
        {
            ...
            Log.e(LOGTAG, error);
            throw new VuException(
                    VuException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void stopAR() throws VuException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new VuException(
                        VuException.UNLOADING_TRACKERS_FAILURE,
                        "Failed to unload trackers\' data");

            if (!deinitTrackersResult)
                throw new VuException(
                        VuException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws VuException
    {
    ...
    public void pauseAR() throws VuException
    {
        if (mStarted)
        {
            stopCamera();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new VuException(
                                VuException.LOADING_TRACKERS_FAILURE,
                                logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new VuException(
                            VuException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(VuSession.this);
